...
namespace Hangfire.DMStorage.Monitoring
{
    internal class DMMonitoringApi: IMonitoringApi
    {
        ...
        public DMMonitoringApi([NotNull] DMStorage storage, int? jobListLimit)
        {
        ...
        public IList<ServerDto> Servers()
        {
            ...
            {
                var servers =
                    connection.Query<Entities.Server>(@"SELECT ""Id"", ""Data"",""LastHeartBeat"" FROM ""Server""").ToList();
...
";
        ...
        {
            const string jobQuery = @"SELECT COUNT(""Id"") FROM ""Job"" WHERE ""StateName"" = :STATE_NAME";
            ...
            var statistics =
                UseConnection(connection =>
                    new StatisticsDto
                    {
                        ...
                        Recurring = connection.ExecuteScalar<int>(@"SELECT COUNT(*) FROM ""Set"" WHERE ""Key"" = 'recurring-jobs'")
                    });
...
SELECT Id
  ...
  FROM (SELECT J.""Id""                                             AS Id
          ...
          FROM ""Job"" J LEFT JOIN ""State"" S ON J.""StateId"" = S.""Id""
